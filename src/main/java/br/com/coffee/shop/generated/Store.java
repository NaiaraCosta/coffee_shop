...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4934126430535692000L;
  ...
  @Deprecated public br.com.coffee.shop.generated.Address address;
   ...
   */
  public Store(java.lang.Integer id, br.com.coffee.shop.generated.Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (br.com.coffee.shop.generated.Address)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public br.com.coffee.shop.generated.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(br.com.coffee.shop.generated.Address value) {
    this.address = value;
  }
   ...
   */
  public static br.com.coffee.shop.generated.Store.Builder newBuilder() {
    return new br.com.coffee.shop.generated.Store.Builder();
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static br.com.coffee.shop.generated.Store.Builder newBuilder(br.com.coffee.shop.generated.Store.Builder other) {
    if (other == null) {
      return new br.com.coffee.shop.generated.Store.Builder();
    } else {
      return new br.com.coffee.shop.generated.Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static br.com.coffee.shop.generated.Store.Builder newBuilder(br.com.coffee.shop.generated.Store other) {
    if (other == null) {
      return new br.com.coffee.shop.generated.Store.Builder();
    } else {
      return new br.com.coffee.shop.generated.Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
    ...
    private int id;
    private br.com.coffee.shop.generated.Address address;
    private br.com.coffee.shop.generated.Address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.coffee.shop.generated.Store.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = br.com.coffee.shop.generated.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.coffee.shop.generated.Store other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.shop.generated.Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.shop.generated.Store.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.shop.generated.Store.Builder setAddress(br.com.coffee.shop.generated.Address value) {
     ...
     * @return This builder.
     */
    public br.com.coffee.shop.generated.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(br.com.coffee.shop.generated.Address.newBuilder(address));
        } else {
          setAddressBuilder(br.com.coffee.shop.generated.Address.newBuilder());
        }
      }
    ...
    public br.com.coffee.shop.generated.Store.Builder setAddressBuilder(br.com.coffee.shop.generated.Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.shop.generated.Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (br.com.coffee.shop.generated.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new br.com.coffee.shop.generated.Address();
      }
